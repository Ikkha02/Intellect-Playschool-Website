...
$sql="SELECT * FROM staff WHERE accID='$uid'";
...
<div class="container">
	<br>
<form method="POST" action="parentpasschangeprocess.php">
  <fieldset>
    <legend>Edit Profile Details</legend>

	<div class="form-group">
	      <label for="exampleInputPassword1" class="form-label mt-4">Change Password</label>
	      <input type="password" name="upassword" class="form-control" id="upassword" placeholder="Please create a strong password" value="<?php echo $row['Acc_Pass']?>">
	  </div>
