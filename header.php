                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="header_contact_info">
                            <a href="mailto:intelek.ria.villa@gmail.com" target="_blank"><i
                                    class="fas fa-envelope"></i>intelek.ria.villa@gmail.com</a>
                            <a href="tel:+012-586 0816"><i class="fas fa-phone"></i>+012-586 0816</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-5 col-md-4">
                        <div class="header_social_icon">
                            ...
                            <a href="https://www.tiktok.com/@intellect_playschool" target="_blank"><i class='Tiktok fontawesomeicon'></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.php"><img src="img/Intellect_playschool_logo.png"
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="createacc.php">Create Account</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="contact.html">Contact</a>
                                    </li>
                                </ul>
                                <a href="login.php" class="cu_btn btn_1">login</a>
                            </div>
                        </nav>
                    </div>
                </div>
