            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="breadcrumb_iner">
                        <h2 class="title wow fadeInDown" data-wow-delay=".3s" >Registration Pending Dashboard</h2>
    ...
    <?php
        while($row=mysqli_fetch_array($result))
        {
         ...
         echo"<td>".$row['r_sent']."</td>";
           echo"<td>";
                    echo"<a href='paymentapprovalreg.php?id=".$row['ReceiptID']."'class='btn btn-warning'>Approval</a>&nbsp";  
