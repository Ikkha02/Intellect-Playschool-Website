        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="section_tittle_style_02">
                        <h2 class="title wow fadeInDown" data-wow-delay=".3s"> <span class="title_overlay_effect"> Programs</span></h2>
                        <p class="description wow fadeInDown" data-wow-delay=".3s">Intellect Playschool mission is to provide
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 wow fadeInDown" data-wow-delay=".2s">
                    <a class="single_service_part d-block" href="fklview.php">
                        <div class="service_section_img_wrapper">
                            <img src="image/fklimage.png" alt="#" class="img-fluid">
                        </div>
                        <h5 class="service_title">Fun Kindyland</h5>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-6 wow fadeInDown" data-wow-delay=".4s">
                    <a class="single_service_part d-block bg_color_2" href="leview.php">
                        <div class="service_section_img_wrapper">
                            <img src="image/leimage.png" alt="#" class="img-fluid">
                        </div>
                        <h5 class="service_title">Little Explorer</h5>
                    </a>
                </div>
            </div>
