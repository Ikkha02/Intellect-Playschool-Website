...
<div class="container">
  <form method="POST" action="createactivitiesupdatestaffprocess.php" enctype="multipart/form-data">
  <fieldset>
    ...
    <div class="form-group">
      <label for="AnnouncementImage" class="form-label mt-4">Insert Image <br> <p>jpg, jpeg, png only</p>
      </label>
