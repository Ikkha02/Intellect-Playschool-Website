...
$sqlk = "SELECT * FROM staff_attendance
        LEFT JOIN staff ON staff_attendance.staffID= staff.accID
        where accID=$fic";
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="breadcrumb_iner">
                        <h2 class="title wow fadeInDown" data-wow-delay=".3s">Staff Attendance </h2>
