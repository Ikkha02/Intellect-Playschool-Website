                ...
                <div class="col-lg-7">
                    <div class="hero_banner_content">
                        ...
                        <p>Kidzo mission is to provide affordable, high-quality early education and childcare services
                            ...
                            <form action="staffviewweeklyprocess.php" class="subscribe_mail input-group" method="POST">
                              ...
                              <div class="form-group">
                                ...
                                <?php 
                                  $sqlstatus = "SELECT * FROM assessment WHERE ChildID = $cid AND Assessment_type = '0'";
