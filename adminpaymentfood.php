...
$sql = "SELECT * FROM foodPayment 
      LEFT JOIN re ON foodPayment.r_status = re.r_stats
      LEFT JOIN program ON foodPayment.p_id = program.Program_ID
      LEFT JOIN children ON foodPayment.ChildID = children.ChildID
      where r_status = '2' or r_status = '0'";
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="breadcrumb_iner">
                        <h2 class="title wow fadeInDown" data-wow-delay=".3s" >Food Pending Dashboard</h2>
...
<h2 class="title wow fadeInDown" data-wow-delay=".3s" >Student <span
  ...
  <thead>
    <tr>
      ...
      <th scope="col" class="title wow fadeInDown" data-wow-delay=".3s">Program Name</th>
      <th scope="col" class="title wow fadeInDown" data-wow-delay=".3s">Payment Status</th>
      <th scope="col" class="title wow fadeInDown" data-wow-delay=".3s">Month</th>
      <th scope="col" class="title wow fadeInDown" data-wow-delay=".3s">Receipt Status</th>
...
<tbody>
    <?php
        while($row=mysqli_fetch_array($result))
        {
         ...
         echo"<td>".$row['r_sent']."</td>";
           echo"<td>";
                    echo"<a href='paymentapprovalfood.php?id=".$row['ReceiptID']."'class='btn btn-warning'>Approval</a>&nbsp";  
