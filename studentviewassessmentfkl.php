            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero_banner_content">
                        ...
                        <p><?php echo $row['AssessmentComments'];?></p>
                        <p><?php echo $row['assessmentID'];?></p>
                        <br>
                        <br>
    ...
    <section class="features_new_area section_padding">
        ...
        <div class="container">
            ...
            <div class="section_tittle_style_02 new_style mb-1">
                <h2 class="title wow fadeInDown" data-wow-delay=".3s" id="c4">Subject Assessment</h2>
                <p class="description wow fadeInDown" data-wow-delay=".3s">Subject Assessment Is Only Available On Fun Kindyland Programme
                </p>
            </div>
