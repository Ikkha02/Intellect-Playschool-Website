...
$sql = "SELECT * FROM payment 
      LEFT JOIN re ON payment.r_status = re.r_stats
      LEFT JOIN program ON payment.p_id = program.Program_ID
      LEFT JOIN children ON payment.ChildID = children.ChildID
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="breadcrumb_iner">
                        <h2 class="title wow fadeInDown" data-wow-delay=".3s" >Monthly Pending Dashboard</h2>
    ...
    <?php
        while($row=mysqli_fetch_array($result))
        {
         ...
         echo"<td>".$row['r_sent']."</td>";
           echo"<td>";
                    echo"<a href='paymentapproval.php?id=".$row['ReceiptID']."'class='btn btn-warning'>Approval</a>&nbsp";  
