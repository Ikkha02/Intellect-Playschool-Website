...
<?php } }?> 
        ...
        <div>
    <br><a href='admin.php' class= 'cu_btn btn_2'>Back</a>
    <a href='activitiesupdatemodifyadmin.php?id=<?php echo $row['activityID'];?>' class= 'cu_btn btn_3'>Modify</a>
    <a href='cancelactivitiesupdateadmin.php?id=<?php echo $row['activityID'];?>' class= 'cu_btn btn_3'  onclick="return confirm('Are you sure you want to delete this activity update?');">Delete</a> <br>
    </div>
