            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero_banner_content">
                        <h2>Fun Kindy Land Assessment <span class="title_overlay_effect"></span></h2>
                        <p>Student: <?php echo $row['Child_name']?></p><br>
                        <form action="insertAssessment.php" method="post">
