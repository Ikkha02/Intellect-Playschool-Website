                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="index_5.html">Home 5</a>
                                            <a class="dropdown-item" href="index_6.html">Home 6</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" role="button"
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact_form form_style">
                        <h2 class="kid_title mb-4"> <span class="title_overlay_effect">Set an appointment.</span>
                        </h2>
                        <form action="dbAppointment.php" method="POST">
                            <div class="row">
                               
                                
                                <div class="col-lg-6">
                                    <div class="form_single_item">
                                        <input type="datetime-local" name="appointment_date" placeholder="Preffered appointment date">
                                    </div>
                                </div>
                                <br>
                                <br>
                            ...
                            <fieldset class="form-group">
                                <legend class="mt-4">Choose a method of appointment</legend>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="appointment_method" id="optionsRadios1" value="1" checked="">
                                  <label class="form-check-label" for="optionsRadios1">
                                    Online meeting
                                  </label>
                                  <br>
                                  <input class="form-check-input" type="radio" name="appointment_method" id="optionsRadios2" value="2" checked="">
            ...
            <div class="row">
                <div class="col-lg-12 p-0">
                    <div class="contactMap">
                        <div id="contactMap" data-lat="40.701083" data-lon="-74.1522848" data-zoom="10"
                            data-info="9 Road, Mirpur Dohs, Dhaka." data-marker="img/map_icon.png" data-mlat="40.701083"
