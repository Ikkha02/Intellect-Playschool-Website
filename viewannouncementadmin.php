...
<?php } }?> 
    ...
    <a href='announcementmodifyadmin.php?id=<?php echo $row['AnnounceID'];?>' class= 'cu_btn btn_3'>Modify</a>
    <a href='cancelannouncementadmin.php?id=<?php echo $row['AnnounceID'];?>' class= 'cu_btn btn_3' onclick="return confirm('Are you sure you want to delete this announcement?');">Delete</a> <br>
    </div>
