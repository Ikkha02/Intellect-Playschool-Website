                ...
                <div class="col-lg-6 ">
                    <div class="breadcrumb_iner">
                        ...
                        <div class="breadcrumb_iner_link">
                            <a href='viewannouncementstaff.php?id=<?php echo $row['AnnounceID'];?>'>Announcement</a>
                            <span>.</span>
...
<div class="container">
  <form method="POST" action="announcementmodifystaffprocess.php" enctype="multipart/form-data">
  <fieldset>
