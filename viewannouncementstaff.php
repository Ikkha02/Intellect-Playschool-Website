...
<?php } }?> 
    ...
    <a href='announcementmodifystaff.php?id=<?php echo $row['AnnounceID'];?>' class= 'cu_btn btn_3'>Modify</a>
    <a href='cancelannouncementstaff.php?id=<?php echo $row['AnnounceID'];?>' class= 'cu_btn btn_3' onclick="return confirm('Are you sure you want to delete this announcement?');">Delete</a> <br>
    </div>
