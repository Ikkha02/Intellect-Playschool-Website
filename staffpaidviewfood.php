...
.content-table tbody tr.active-row {
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="breadcrumb_iner">
                        <h2 class="title wow fadeInDown" data-wow-delay=".3s">Food Paid Dashboard</h2>
    ...
    <Br>
    <form class="form-horizontal" method ="POST" action="staffapprovalfood.php">
    ...
    <?php
        while($row=mysqli_fetch_array($result))
        {
         ...
         echo"<td>".$row['r_desc']."</td>";
          echo"<td>";
                    echo"<a href='paymentapprovalfoodpaid.php?id=".$row['ReceiptID']."'class='btn btn-warning'>View</a>&nbsp";  
