                    ...
                    <div class="col-lg-12">
                        ...
                        <a class="navbar-brand" href="index.php"><img src="img/Intellect_playschool_logo.png"
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="Allprogram.php">View Programs</a>
                                    </li>                                   
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="RegFKL.php">Fun KindyLand</a>
                                            <a class="dropdown-item" href="RegLE.php">Little Explorer</a>
                                            <a class="dropdown-item" href="RegWP.php">Weekly Playgroups</a>
                                            <a class="dropdown-item" href="parentmanagereg.php">View Registration History</a>
