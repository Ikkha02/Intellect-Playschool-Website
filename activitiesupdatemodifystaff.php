                ...
                <div class="col-lg-6 ">
                    <div class="breadcrumb_iner">
                        ...
                        <div class="breadcrumb_iner_link">
                            <a href='viewactivitiesupdatestaff.php?id=<?php echo $row['activityID'];?>'>Activity update</a>
                            <span>.</span>
...
<div class="container">
  <form method="POST" action="activitiesupdatemodifystaffprocess.php" enctype="multipart/form-data">
  <fieldset>
