                ...
                <div class="row align-items-left">
                    <div class="col-lg-1">
                        <nav class="navbar navbar-expand-lg navbar-light">
                                    <a class="navbar-brand" href="staff.php"><img src="img/Intellect_playschool_logo.png"
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="staffappapproval.php">Verify Appointment</a>
                                            <a class="dropdown-item" href="staffregapproval.php">Verify Registration</a>
                                            <a class="dropdown-item" href="staffmanagereg.php">Modify Registration</a>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="createannouncementstaff.php">Create announcement</a>
                                            <a class="dropdown-item" href="createactivitiesupdatestaff.php">Create activities update</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" role="button"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="payslipview.php">Payslip</a>
                                    </li>                      
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" role="button"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="staffattendancemain.php">Staff Attendance</a>
                                            <a class="dropdown-item" href="viewstaffatt.php">View Staff Attendance</a>
                                            <a class="dropdown-item" href="realattendancemain.php">Student Attendance</a>
                                            <a class="dropdown-item" href="viewrealattendance.php">View Student Attendance</a>
